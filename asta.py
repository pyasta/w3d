     ...
     if "الرقم ↢"  in message.text:
         if not mci in dis3:
          ...
          if start_index != -1 and end_index != -1:
           ...
           await message.reply( f"{copied_text}")
           time.sleep(3)
           await asta.send_message(message.chat.id,f"ارقام")
     ...
     if "الكلمة ↢"  in message.text:
      if not mci in dis2:
       ...
       if start_index != -1 and end_index != -1:
        ...
        await message.reply( f"{copied_text}")
        time.sleep(3)
        await asta.send_mesaage( f"كلمات")
     ...
     if "فكك ↢"  in message.text:
      if not mci in dis3:
       ...
       if start_index != -1 and end_index != -1:
        ...
        await message.reply( f"{spaced_text}")
        time.sleep(3)
        await asta.send_message(message.chat.id,"تفكيك")
     ...
     if "ركب ↢"  in message.text:
       if not mci in dis4:
        ...
        if start_index != -1 and end_index != -1:
         ...
         await message.reply( f"{no_spaces_text}")
         time.sleep(3)
         await asta.send_message(message.chat.id,"تركيب")
